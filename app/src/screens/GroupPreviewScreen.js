      ...
      <View style={androidStyles.container}>
        ...
        >
          ...
          <View style={androidStyles.header}>
            ...
            <Text style={androidStyles.headerTitle}>Preview</Text>
          ...
          {/* White Content Area */}
          <View style={androidStyles.whiteContent}>
            <View style={androidStyles.card}>
              {/* Group Name */}
              <View style={androidStyles.groupNameSection}>
                <Text style={androidStyles.groupNameLabel}>Group</Text>
                <Text style={androidStyles.groupNameText} numberOfLines={1}>{groupName}</Text>
              </View>

              {/* Expenses List */}
              <View style={androidStyles.expensesSection}>
                <Text style={androidStyles.sectionTitle}>Expenses ({expenses.length})</Text>
                
                <ScrollView 
                  style={androidStyles.expensesScroll}
                  contentContainerStyle={androidStyles.expensesScrollContent}
                  showsVerticalScrollIndicator={true}
                  nestedScrollEnabled={true}
                >
                  {expenses.map((expense, index) => (
                    <View key={index} style={androidStyles.expenseRow}>
                      <View style={androidStyles.expenseTopRow}>
                        <Text style={androidStyles.expenseTitle} numberOfLines={1}>{expense.title}</Text>
                        <Text style={androidStyles.expenseAmount}>₹{expense.totalAmount.toFixed(2)}</Text>
                      </View>
                      <View style={androidStyles.expenseBottomRow}>
                        <Text style={androidStyles.expensePaidBy} numberOfLines={1}>Paid by: {expense.paidByName}</Text>
                        <TouchableOpacity 
                          style={androidStyles.viewMembersLink}
                          onPress={() => openMemberModal(index)}
                        >
                          <Text style={androidStyles.viewMembersText}>View expense</Text>
                        </TouchableOpacity>
                      </View>
                    </View>
                  ))}
              ...
              {/* Checkout Button */}
              <TouchableOpacity
                style={[androidStyles.createButton, isCreating && androidStyles.createButtonDisabled]}
              ...
              >
                {isCreating ? (
                  ...
                  <Text style={androidStyles.createButtonText}>Checkout</Text>
                )}
              </TouchableOpacity>
            </View>
          </View>
        ...
        >
          <View style={androidStyles.modalOverlay}>
            <View style={androidStyles.modalContent}>
              <View style={androidStyles.modalHeader}>
                <Text style={androidStyles.modalTitle}>View Expense</Text>
                <TouchableOpacity onPress={() => setModalVisible(false)}>
                  <Text style={androidStyles.modalClose}>✕</Text>
                </TouchableOpacity>
              </View>

              {activeExpenseIndex !== null && expenses[activeExpenseIndex] && (
                <>
                  <View style={androidStyles.modalTotalRow}>
                    <Text style={androidStyles.modalTotalLabel}>Total Amount:</Text>
                    <Text style={androidStyles.modalTotalValue}>
                      ₹{expenses[activeExpenseIndex].totalAmount.toFixed(2)}
                    </Text>
                  </View>

                  <ScrollView style={androidStyles.membersList}>
                    {expenses[activeExpenseIndex].members.map(member => (
                      <View key={member.mailId} style={androidStyles.memberRow}>
                        <View style={androidStyles.memberInfo}>
                          <Text style={androidStyles.memberName} numberOfLines={1}>{member.name}</Text>
                          {member.mailId === expenses[activeExpenseIndex].paidBy && (
                            <Text style={androidStyles.payerBadge}>Payer</Text>
                          )}
                        </View>
                        <View style={androidStyles.amountInputContainer}>
                          <Text style={androidStyles.currencySymbol}>₹</Text>
                          <TextInput
                            style={androidStyles.amountInput}
                  ...
                  <View style={androidStyles.modalSummary}>
                  ...
                  {splitError && (
                    <Text style={androidStyles.splitErrorText}>{splitError}</Text>
                  )}

                  <TouchableOpacity
                    style={androidStyles.saveButton}
                    onPress={validateAndSaveSplits}
                  >
                    <Text style={androidStyles.saveButtonText}>Save Split</Text>
                  </TouchableOpacity>
                </>
              )}
            </View>
